...
3. Définissez votre mot de passe (min. 8 caractères recommandé)
4. Vous êtes automatiquement connecté

### Connexions suivantes

1. Rendez-vous sur `https://ansut-lens.lovable.app`
...
Le menu latéral (à gauche) vous donne accès à toutes les fonctionnalités :
...
| Catégorie | Technologie, Régulation, Économie, etc. |
...
|----------|-----------------|
| "Quelles sont les dernières actualités sur la 5G ?" | Liste d'articles récents |
| "Résume l'activité de Orange CI cette semaine" | Synthèse des mentions |
...
2. Utilisez l'Assistant IA pour vos questions
