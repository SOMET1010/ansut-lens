...
import { Eye, Plus, Shield, AlertTriangle, CheckCircle, Trash2, Send, Linkedin, Twitter } from "lucide-react";
...
/**
 * Veille des dirigeants — suivi des prises de parole des directeurs et VIP.
 *
 * Extrait en composant pour vivre dans le PRODUIT (onglet « Veille dirigeants »
 * d'Acteurs) autant que dans la console d'administration. Savoir qui parle et
 * comment au sein de la direction relève de la connaissance des acteurs : sa
 * place est auprès de la cartographie d'influence, pas dans les réglages.
 */
export function VeilleDirigeants() {
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="flex items-center gap-2 text-lg font-semibold"><Eye size={18} /> Veille des dirigeants</h2>
          <p className="text-sm text-muted-foreground">Suivi des prises de parole des directeurs et VIP internes sur les réseaux sociaux.</p>
        </div>
