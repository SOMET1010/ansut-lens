...
/**
 * Carte compacte d'un sujet du Briefing — vue partagée entre « La Matinale »
 * et la page dédiée « Tous les sujets ». Purement présentationnelle : elle ne
 * fait que restituer les preuves déjà attachées au sujet.
 */
export function CarteSujetBriefing({ sujet }: { sujet: SujetBriefing }) {
